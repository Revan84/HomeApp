...
class CobLedRgbColorWheel extends StatefulWidget {
  final Color color;
  final ValueChanged<Color> onColorChanged;

  const CobLedRgbColorWheel({
    super.key,
    required this.color,
  ...
  @override
  State<CobLedRgbColorWheel> createState() => _CobLedRgbColorWheelState();
}

class _CobLedRgbColorWheelState extends State<CobLedRgbColorWheel> {
  late HSVColor _hsv;
  ...
  @override
  void didUpdateWidget(CobLedRgbColorWheel old) {
