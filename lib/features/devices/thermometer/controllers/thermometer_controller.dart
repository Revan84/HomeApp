...
/// Controller for the thermometer detail screen.
class ThermometerController extends BaseEquipmentController {
  ...
  /// Returns the temperature history for the given time window.
